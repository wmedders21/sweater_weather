...
RSpec.describe 'road_trip endpoint' do
  ...
  describe 'edge cases/sad paths', :vcr do
    ...
    it 'sad path wrong api key' do
      body = { origin: "Denver, CO", destination: "Pueblo, CO", api_key: "09876" }
      headers = {"CONTENT_TYPE" => "application/json"}
    ...
    it 'sad path no origin' do
      body = { destination: "Pueblo, CO", api_key: "#{@user.api_key}" }
      headers = {"CONTENT_TYPE" => "application/json"}
    ...
    it 'sad path no destination' do
      body = { origin: "Pueblo, CO", api_key: "#{@user.api_key}" }
      headers = {"CONTENT_TYPE" => "application/json"}
    ...
    it 'sad path empty origin' do
      body = { origin: "", destination: "Pueblo, CO", api_key: "#{@user.api_key}" }
      headers = {"CONTENT_TYPE" => "application/json"}
    ...
    it 'sad path empty destination' do
      body = { origin: "Denver, CO", destination: "", api_key: "#{@user.api_key}" }
      headers = {"CONTENT_TYPE" => "application/json"}
